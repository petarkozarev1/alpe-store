      ...
      <section className="max-w-content mx-auto px-6 md:px-10 pt-32 pb-20">
        ...
        <div className="max-w-2xl flex flex-col gap-10 font-sans text-sm text-stone leading-relaxed">
          ...
          <section>
            ...
            <p className="mt-3">Предлагаме плащане с карта (чрез Stripe) и плащане в брой при доставка (наложен платеж). При наложен платеж се начислява такса за услугата в размер на 1,00 €, видима в обобщението на поръчката преди потвърждение. Правото на отказ в рамките на 14 дни и законовата гаранция от 24 месеца важат независимо от избрания начин на плащане.</p>
          </section>
