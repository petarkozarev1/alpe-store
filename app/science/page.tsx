...
const facts = [
  ...
  },
  {
    ...
    body: 'Повечето хора усещат разлика в умората на очите още след 3-4 дни. Качеството на съня се подобрява след около седмица. Ако не усетиш нищо — върни ги. Без въпроси.',
  },
]
