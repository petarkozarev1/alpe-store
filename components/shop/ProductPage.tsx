      ...
      <section style={{ padding: '80px 48px', background: '#FAF0E4' }}>
        <div style={{ maxWidth: 1020, margin: '0 auto' }}>
          ...
          <div style={{ display: 'grid', gridTemplateColumns: 'repeat(4,1fr)', gap: 2 }}>
            {[
              { n: '1', title: 'Днес', body: 'Използвайте дневните очила по време на работа и вечерните поне 2 часа преди лягане. Очите ви ще усетят разликата веднага. По-малко напрежение, повече спокойствие.', dark: false },
