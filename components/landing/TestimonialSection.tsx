...
export default function TestimonialSection() {
  return (
    <section className="w-full bg-brand-off-white py-24">
      <div className="max-w-content mx-auto px-6 md:px-10 flex flex-col items-center text-center">
        ...
        <motion.blockquote
          ...
          viewport={{ once: true }}
          className="mt-6 text-2xl font-bold leading-snug max-w-2xl text-brand-black"
        >
          &ldquo;{testimonialContent.quote}&rdquo;
        </motion.blockquote>

        <p className="mt-4 text-brand-muted text-sm">~ {testimonialContent.author}</p>
      </div>
    </section>
  )
}
